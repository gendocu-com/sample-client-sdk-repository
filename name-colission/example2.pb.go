...
// 	protoc        v3.12.2
// source: name-colission/example2.proto
...
func (x *ExampleMessage1) Reset() {
	*x = ExampleMessage1{}
	if protoimpl.UnsafeEnabled {
		mi := &file_name_colission_example2_proto_msgTypes[0]
...
func (*ExampleMessage1) Descriptor() ([]byte, []int) {
	return file_name_colission_example2_proto_rawDescGZIP(), []int{0}
}
...
func (x *ExampleMessage2) Reset() {
	*x = ExampleMessage2{}
	if protoimpl.UnsafeEnabled {
		mi := &file_name_colission_example2_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExampleMessage2) Descriptor() ([]byte, []int) {
	return file_name_colission_example2_proto_rawDescGZIP(), []int{1}
}
...
func (x *ReturnType) Reset() {
	*x = ReturnType{}
	if protoimpl.UnsafeEnabled {
		mi := &file_name_colission_example2_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ReturnType) Descriptor() ([]byte, []int) {
	return file_name_colission_example2_proto_rawDescGZIP(), []int{2}
}
...
func (x *ExampleMessage2_ExampleNested) Reset() {
	*x = ExampleMessage2_ExampleNested{}
	if protoimpl.UnsafeEnabled {
		mi := &file_name_colission_example2_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExampleMessage2_ExampleNested) Descriptor() ([]byte, []int) {
	return file_name_colission_example2_proto_rawDescGZIP(), []int{1, 0}
}
...
var File_name_colission_example2_proto protoreflect.FileDescriptor

var file_name_colission_example2_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x6e, 0x61, 0x6d, 0x65, 0x2d, 0x63, 0x6f, 0x6c, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x2f, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x32, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22,
...
var (
	file_name_colission_example2_proto_rawDescOnce sync.Once
	file_name_colission_example2_proto_rawDescData = file_name_colission_example2_proto_rawDesc
)

func file_name_colission_example2_proto_rawDescGZIP() []byte {
	file_name_colission_example2_proto_rawDescOnce.Do(func() {
		file_name_colission_example2_proto_rawDescData = protoimpl.X.CompressGZIP(file_name_colission_example2_proto_rawDescData)
	})
	return file_name_colission_example2_proto_rawDescData
}

var file_name_colission_example2_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_name_colission_example2_proto_goTypes = []interface{}{
...
var file_name_colission_example2_proto_depIdxs = []int32{
...
func init() { file_name_colission_example2_proto_init() }
func file_name_colission_example2_proto_init() {
	if File_name_colission_example2_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_name_colission_example2_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_name_colission_example2_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_name_colission_example2_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_name_colission_example2_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_name_colission_example2_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_name_colission_example2_proto_goTypes,
		DependencyIndexes: file_name_colission_example2_proto_depIdxs,
		MessageInfos:      file_name_colission_example2_proto_msgTypes,
	}.Build()
	File_name_colission_example2_proto = out.File
	file_name_colission_example2_proto_rawDesc = nil
	file_name_colission_example2_proto_goTypes = nil
	file_name_colission_example2_proto_depIdxs = nil
}
...
var _ExampleService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "name-colission/example2.proto",
}
